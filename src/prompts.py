...
def build_system_prompt(participant: ParticipantConfig, meeting_title: str) -> str:
    return (
        ...
        "- Messages from other AI participants appear as: [Name]: message\n"
        ...
        "- Be concise and focused; keep your responses to 2-4 paragraphs "
        "unless the topic demands more detail.\n"
